...
WinScene::WinScene() : dx9GpuDescriptor{}
{
...
void WinScene::OnDeviceLost()
{

}

// Restart any looped sounds here
void WinScene::OnRestartSound()
{

}

// Updates the scene.
NextScene WinScene::Update(const float deltaTime)
{
